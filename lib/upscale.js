/**
 * Чистая логика увеличения изображений через локальный GPU-сервер.
 * Не зависит от API браузера или расширения.
 */

/**
 * Проверяет доступность сервера увеличения.
...
/**
 * Отправляет изображение на увеличение и возвращает URL результата.
